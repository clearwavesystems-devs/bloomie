...
class _JournalScreenState extends State<JournalScreen> {
  ...
  void _saveEntry() async {
    ...
    final success = await context.read<JournalCubit>().completeJournalEntry(_contentController.text.trim());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: _moods.map((m) {
                                    ...
                                    return GestureDetector(
                                      onTap: () => context.read<JournalCubit>().selectMood(m.$1, m.$3),
                                      child: AnimatedContainer(
                                        duration: const Duration(milliseconds: 200),
                                        padding: EdgeInsets.symmetric(horizontal: 10.w, vertical: 10.h),
                                        decoration: BoxDecoration(
                                          color: isSelected ? AppColors.pinkLight : Colors.transparent,
                                        ...
                                        child: Column(
                                          children: [
                                            Text(m.$1, style: TextStyle(fontSize: 28.sp)),
                                            SizedBox(height: 4.h),
                                            Text(
                                              m.$2,
                                ...
                                TextFormField(
                                  ...
                                  maxLines: 4,
                                  validator: (v) => v!.trim().isEmpty ? 'Write a few words' : null,
                                  style: GoogleFonts.nunito(color: AppColors.textDark),
                                  decoration: InputDecoration(
                                    hintText: 'What went well? What is on your mind?',
                                    hintStyle: GoogleFonts.nunito(color: AppColors.textMuted, fontSize: 13.sp),
                                    filled: true,
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Complete Entry',
                                          style: GoogleFonts.baloo2(fontSize: 15.sp, fontWeight: FontWeight.bold),
                                        ),
                                        SizedBox(width: 8.w),
                                        Text(
                                          '✨ +100 XP',
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.nunito(color: AppColors.textMuted, fontSize: 12.sp),
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate((context, index) {
                        ...
                        final dateText = DateFormat.yMMMMd().add_jm().format(entry.createdAt);
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(color: AppColors.creamBg, shape: BoxShape.circle),
                                child: Text(entry.mood, style: TextStyle(fontSize: 24.sp)),
                              ),
                              SizedBox(width: 14.w),
                              Expanded(
                                child: Column(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(
              'Reflected Today!',
              style: GoogleFonts.baloo2(fontSize: 18.sp, fontWeight: FontWeight.w800, color: AppColors.textDark),
            ),
            SizedBox(width: 6.w),
            Text('✨', style: TextStyle(fontSize: 20.sp)),
          ],
        ...
        Text(
          '"${entry.content}"',
          style: GoogleFonts.nunito(fontSize: 14.sp, fontStyle: FontStyle.italic, color: AppColors.textDark),
          textAlign: TextAlign.center,
        ),
      ],
    );
