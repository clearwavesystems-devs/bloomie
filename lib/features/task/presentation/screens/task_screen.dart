  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text('Retry', style: GoogleFonts.baloo2(color: Colors.white)),
                    ),
                  ],
                ),
              ),
          ...
          if (state is TaskLoaded) {
            ...
            return CustomScrollView(
              slivers: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.nunito(fontSize: 13.sp, color: AppColors.textDark.withValues(alpha: 0.7)),
                        ),
                      ],
                    ),
                  ),
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    padding: EdgeInsets.only(left: 20.w, right: 20.w, top: 20.h, bottom: 8.h),
                    child: Text(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate((context, index) {
                        ...
                        return TaskCard(
                          ...
                          elapsedSeconds: activeTimerId == task.id ? elapsedSecs : 0,
                          onComplete: () => context.read<TaskCubit>().completeTask(task.id),
                          onDelete: () => context.read<TaskCubit>().deleteTask(task.id),
                          onStartTimer: () => context.read<TaskCubit>().startTimer(task.id),
                          onPauseTimer: () => context.read<TaskCubit>().pauseTimer(),
                          onStopTimer: () => context.read<TaskCubit>().stopTimer(),
                        );
                ...
                if (completed.isNotEmpty) ...[
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: EdgeInsets.only(left: 20.w, right: 20.w, top: 16.h, bottom: 4.h),
                      child: InkWell(
                        onTap: () {
                          setState(() {
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Icon(
                                _isCompletedExpanded ? SolarIconsOutline.altArrowUp : SolarIconsOutline.altArrowDown,
                                color: AppColors.textMuted,
                              ),
                            ],
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        elevation: 6,
        child: const Icon(SolarIconsOutline.addSquare, color: Colors.white, size: 28),
      ),
    );
  }
}
